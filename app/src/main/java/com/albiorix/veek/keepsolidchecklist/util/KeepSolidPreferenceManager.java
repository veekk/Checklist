...
public class KeepSolidPreferenceManager {
    static private KeepSolidPreferenceManager instance;

    public static KeepSolidPreferenceManager getInstance() {
        if (instance == null) {
            instance = new KeepSolidPreferenceManager();
        }
        return instance;
    }
